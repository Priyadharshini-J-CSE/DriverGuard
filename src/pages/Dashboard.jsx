  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Active Policy"     value={policy ? policy.planType.toUpperCase() : 'None'}                          icon={ShieldCheck}   color="blue"   subtitle={policy ? `Weekly premium: ₹${policy.weeklyPremium}` : 'No active plan'} />
